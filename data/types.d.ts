import type { domEventInterfaces, htmlDomEvents, mathMlTags, svgEvents, svgTags, webComponentsInterfaces } from './types.ts';
import type { domInterfaces, htmlDomInterfaces, htmlTags, jsInterfaces, jsTypedArrayInterfaces, svgInterfaces, urlFragmentInterfaces, webAnimationsInterfaces } from './types.ts';
...
export type JsTypedArrayInterfaces = Readonly<typeof jsTypedArrayInterfaces[number]>;
...
export type WebAnimationsInterfaces = Readonly<typeof webAnimationsInterfaces[number]>;
export type webComponentsInterfaces = Readonly<typeof webComponentsInterfaces[number]>;